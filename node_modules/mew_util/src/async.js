...
var Async = function Async(action, pool, fulfilled) {
    ...
    this.pendingRejectedActions = [(function (error) {
    ...
    var step = {
        ...
        "next": function () {
            ...
            if ((self.state === HELD) ||
                ...
                async.pendingTaskAsyncs = [];
                async.pendingRejectedActions = [];

                asyncs.forEach(function (async2) {
                    call.call(async2, self.fulfilled);
                });

                async.followingAsyncs = [];
...
Async.prototype.then = function (task) {
...
Async.prototype.rejected = function (action) {
...
Async.prototype.pipe = function (superasync) {
...
Async.prototype.finished = function (finish) {
...
Async.prototype.all = function (list, action) {
...
Async.prototype.any = function (list, action) {
...
Async.prototype.test = function (test) {
