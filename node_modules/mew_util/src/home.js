...
var mergeConfig = function (rule, config) {
    return foundation.advancedMerge(registeredConfigs[rule], config);
};
...
var requireModule = function (module, id) {
    ...
    if (possibleRootPath) {
        ...
        return require("module").prototype.require.call(module, moduleID);
    }
...
var resolveModule = function (module, id) {
    ...
    if (id[0] === ".") {
        ...
        var idHasExtname = ([".js", ".json"].indexOf(path.extname(id)) !== -1);
        ...
        while (dir !== path.dirname(dir)) {
            ...
            var fs = getUtilFS(moduleID);
            if (fs.existsSync(moduleID) && (fs.statSync(moduleID).isDirectory() || (fs.statSync(moduleID).isFile() && idHasExtname))) {
                return moduleID;
...
require("module")._extensions[".mew-js"] = function (module, filename, parent) {
    ...
    try{
        ...
        console.log("Failed to compile file " + filename);
        throw error;
    }
};
...
var evaluateScript = function (script, filename, require) {
    ...
    process.binding("evals").NodeScript.runInThisContext(Module.wrap(script), filename, true).call(sandbox.exports,
        sandbox.exports,
        sandbox.require,
        sandbox,
